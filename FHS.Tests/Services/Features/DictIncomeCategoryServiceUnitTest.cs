...
{
    public class DictIncomeCategoryServiceUnitTest : BaseCrudServiceUnitTest<DictIncomeCategoryListModel, DictIncomeCategoryModel, DictIncomeCategory, IDictIncomeCategoryMapper, DictIncomeCategoryService>
    {
        public DictIncomeCategoryServiceUnitTest(DatabaseFixture<DictIncomeCategory> fixture) : base(fixture)
        {
            _service = new DictIncomeCategoryService(_loggerMock.Object, _dbContext, _mapperMock.Object);
        }
    }
}
